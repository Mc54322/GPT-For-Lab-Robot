...
while True:
    ...
    # Get description of the current camera feed
    image_prompt = itg.get_text_from_image()
    ...
    messages = [
        ...
        {"role": "user", "content": f"The current view of the camera is: '{image_prompt}'. Use this if needed."}
    ]
